...
class EngineeredModel2LVOne:
    ...
    def __init__(self, filters_2=10000,im_size=224):
    ...
    def Build(self):
        ...
        c2 = nn.Conv2d(out_channels, self.filters_2, kernel_size=(5, 5))
        mp2 = nn.MaxPool2d(kernel_size=2)
        last = Output()

        return Model(vone,mp1,c2,mp2,last)  
