...
class ExpansionModelGabor:
    ...
    def __init__(self, 
        ...
        self.filters_1 = self.gabor_params['n_ories']
    ...
    def Build(self):        
        ...
        # layer 1
        conv1 = Convolution(filter_size=15,filter_type='gabor',curv_params=self.gabor_params)     
