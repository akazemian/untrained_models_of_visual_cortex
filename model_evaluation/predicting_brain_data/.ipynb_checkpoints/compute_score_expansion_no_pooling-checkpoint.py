...
from model_features.models.expansion_no_pooling import Expansion5L
    ...
    for model_name in MODELS:
        ...
        for features in FEATURES:
            for random_filters in FILTERS:
                ...
                activations_identifier = activations_identifier + '_no_pooling'
                print(activations_identifier)
                
                model = Expansion5L(filters_5=features).Build()
