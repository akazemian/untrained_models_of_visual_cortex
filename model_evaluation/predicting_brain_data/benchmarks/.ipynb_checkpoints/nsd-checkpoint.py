...
# def get_best_model_layer(activations_identifier, region, device, subject):
...
#             regression = fit_model_for_subject_roi(subject, region, activations_data, device, sample)                
#             scores.append(regression.score_.mean())
#             alphas.append(float(regression.alpha_))
...
# def nsd_get_best_layer_scores(activations_identifier: list, region: str, subject:int):
...
#         best_layer, best_alphas = get_best_model_layer(activations_identifier, region, sample)            
#         activations_data = xr.open_dataarray(os.path.join(CACHE,'activations',best_layer), engine='h5netcdf')  
...
#                                                     subject = subject,
#                                                     region = region)
#         X_train = filter_activations(data = activations_data, ids = ids_train).values       
#         y_train = neural_data_train[var_name_train].values
...
#         X_test = filter_activations(data = activations_data, ids = ids_test).values               
#         y_test = neural_data_test[var_name_test].values                    
