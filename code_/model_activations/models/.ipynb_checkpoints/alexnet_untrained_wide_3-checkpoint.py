...
class AlexnetU3:
    ...
    def Build(self):
        ...
        conv1 = Conv2d(3, 1000, kernel_size=(11, 11), stride=(4, 4), padding=(2, 2))
        relu1 = ReLU(inplace=True)
        mp1 = MaxPool2d(kernel_size=3, stride=2, padding=0, dilation=1, ceil_mode=False)
        
        conv2 = Conv2d(1000, 2000, kernel_size=(5, 5), stride=(1, 1), padding=(2, 2))
        relu2 = ReLU(inplace=True)
        mp2 = MaxPool2d(kernel_size=3, stride=2, padding=0, dilation=1, ceil_mode=False)
        
        conv3 = Conv2d(2000, 5000, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
        relu3 = ReLU(inplace=True)
        
        conv4 = Conv2d(5000, 5000, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
        relu4 = ReLU(inplace=True)
        mp4 = MaxPool2d(kernel_size=3, stride=2, padding=0, dilation=1, ceil_mode=False)
        
        conv5 = Conv2d(5000, self.filters_5, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
