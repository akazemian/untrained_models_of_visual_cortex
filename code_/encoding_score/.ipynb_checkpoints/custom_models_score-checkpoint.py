...
from model_features.models.utils import load_model, load_full_identifier
from model_features.models.configs import model_cfg as cfg
    ...
    for model_name in MODELS:
        ...
        if model_name in ['expansion_linear','fully_random'] and region != 'ventral visual stream':
            ...
            for features in cfg[DATASET]['models'][model_name]['features']:
                ...
                activations_identifier = load_full_identifier(model_name=model_name, features=features, layers=cfg[DATASET]['models'][model_name]['layers'], dataset=DATASET)
