...
def main():
    ...
    ALL_MODELS = ['alexnet_trained','alexnet_untrained','vit_untrained','vit_trained','resnet50_trained']
    N_BOOTSTRAPS = 100
    ...
    models = [args.model] if args.model is not None else ALL_MODELS 
    ...
    for model_name in models:
        ...
        for region in cfg[args.dataset]['regions']:
            ...
            for layer_num in layers_dict[model_name]:
